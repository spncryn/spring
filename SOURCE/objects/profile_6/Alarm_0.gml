if instance_number(dm_player) < global.dm_player_history5
{
...
if instance_number(dm_other) < global.dm_other_history5
{
...
if  (instance_number(dm_player) == global.dm_player_history5)
and (instance_number(dm_other) == global.dm_other_history5)
{
	global.no = 0;
