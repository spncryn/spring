if instance_number(dm_player) < global.dm_player_history3
{
...
if instance_number(dm_other) < global.dm_other_history3
{
...
if  (instance_number(dm_player) == global.dm_player_history3)
and (instance_number(dm_other) == global.dm_other_history3)
{
	global.no = 0;
