if instance_number(dm_player) < global.dm_player_history0
{
...
if instance_number(dm_other) < global.dm_other_history0
{
...
if  (instance_number(dm_player) == global.dm_player_history0)
and (instance_number(dm_other) == global.dm_other_history0)
{
	global.no = 0;
