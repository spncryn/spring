if instance_number(dm_player) < global.dm_player_history2
{
...
if instance_number(dm_other) < global.dm_other_history2
{
...
if  (instance_number(dm_player) == global.dm_player_history2)
and (instance_number(dm_other) == global.dm_other_history2)
{
	global.no = 0;
