if instance_number(dm_player) < global.dm_player_history1
{
...
if instance_number(dm_other) < global.dm_other_history1
{
...
if  (instance_number(dm_player) == global.dm_player_history1)
and (instance_number(dm_other) == global.dm_other_history1)
{
	global.no = 0;
